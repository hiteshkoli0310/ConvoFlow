...
function detectLanguageSync(text) {
  try {
    ...
    const commonItalian =
      /\b(il|di|e|la|che|per|un|a|da|in|del|nel|al|le|con|non|alla|si|dei|gli|ha|più|su|delle|dalla|questa|della|può|nelle|ai|nel|anche|dalla|sono|essere|tra|tutti|se|fra|nelle|nelle|cosa|oltre|dall|allo|questi|tutto|altro|altri|dopo|nei|quindi|sempre|sia|molto|tre|prima|solo|anni|oggi|due|fatto|altro|come|anno|così|tra|senza|ancora|già|fare|grande|mai|mentre|modo|primo|vita|volta)\b/i;
